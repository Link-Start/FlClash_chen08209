...
/// Pulls the bullet list out of a GitHub release body.
///
/// The body ends with the download table from `.github/release_template.md`,
/// so parsing stops at the markers `tool/changelog.dart render release` writes.
/// Releases published before those markers existed fall back to scanning the
/// whole body, where the line anchor keeps the table's markup out.
