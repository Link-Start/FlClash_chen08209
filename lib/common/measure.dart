...
class Measure {
  ...
  // A TextPainter owns a native paragraph, and these run inside layout — once
  // per visible row per layout pass — so the painter has to be released as soon
  // as its measurement has been read.
  R _measuring<R>(
    Text text,
    TextStyle? style,
    double? maxWidth,
