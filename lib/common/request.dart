...
class Request {
  ...
  // Constructed at import time, before the ProviderContainer exists, so the
  // reader is wired in once the container is built.
  ...
  Future<Result<IpInfo?>> checkIp({CancelToken? cancelToken}) async {
    ...
    final futures = _ipInfoSources.entries.map((source) async {
      ...
      // The completer is what callers await; this chain only feeds it.
      unawaited(
        future
            .then((res) {
