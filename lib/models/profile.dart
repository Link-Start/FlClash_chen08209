...
extension ProfilesExt on List<Profile> {
  ...
  String _getLabel(String label, int id) {
    ...
    if (hasDup) {
      ...
      // `realLabel`, not `label`: the id fallback and the trimming that the
      // duplicate check above already relies on have to reach the stored value
      // too, otherwise an unnamed profile keeps an empty label forever.
      return realLabel;
    }
  }
