...
mixin _$ChangelogEntry {
 ...
 String get id; String? get scope; Map<String, String> get text;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChangelogEntry&&(identical(other.id, id) || other.id == id)&&(identical(other.scope, scope) || other.scope == scope)&&const DeepCollectionEquality().equals(other.text, text));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,scope,const DeepCollectionEquality().hash(text));
...
@useResult
$Res call({
 String id, String? scope, Map<String, String> text
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? scope,  Map<String, String> text)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChangelogEntry() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? scope,  Map<String, String> text)  $default,) {final _that = this;
switch (_that) {
case _ChangelogEntry():
return $default(_that.id,_that.scope,_that.text);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? scope,  Map<String, String> text)?  $default,) {final _that = this;
switch (_that) {
case _ChangelogEntry() when $default != null:
return $default(_that.id,_that.scope,_that.text);case _:
  return null;
...
class _ChangelogEntry implements ChangelogEntry {
  const _ChangelogEntry({required this.id, this.scope, final  Map<String, String> text = const {}}): _text = text;
...
@override@JsonKey() Map<String, String> get text {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChangelogEntry&&(identical(other.id, id) || other.id == id)&&(identical(other.scope, scope) || other.scope == scope)&&const DeepCollectionEquality().equals(other._text, _text));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,scope,const DeepCollectionEquality().hash(_text));
