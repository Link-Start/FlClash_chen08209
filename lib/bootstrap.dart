...
/// Startup orchestration. This is the only part of the app that drives the
/// window, the autostart entry and the permission prompts, which is why it
/// lives above `lib/common` rather than on `GlobalState` — every file that
/// imports the common barrel would otherwise compile against those plugins.
class Bootstrap {
