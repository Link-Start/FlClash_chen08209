...
/// The shared body of the custom-overwrite editors that manage one named list
/// on a `ProxyGroup`: a reorderable, dismissible list plus an include-all
/// toggle. `lens` binds it to the field pair a caller owns.
