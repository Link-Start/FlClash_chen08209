...
class _OnDemandViewState extends ConsumerState<OnDemandView>
  ...
  /// The shared shape of the two prerequisite buttons: neutral once the
  /// permission is held, error-coloured while it is still missing.
  ...
  // `itemsProvider` is a shared selection notifier keyed by a widget id, so its
  // element type is dynamic rather than the SSIDs this view puts in it.
