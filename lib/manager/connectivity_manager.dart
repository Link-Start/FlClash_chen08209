...
class _ConnectivityManagerState extends ConsumerState<ConnectivityManager> {
  ...
  /// Drops the result of a read that a later connectivity change has already
  /// superseded. The native lookup waits for a Wi-Fi callback and can take
  /// seconds, so reads finish out of order when the network flaps.
