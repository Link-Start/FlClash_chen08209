...
// Config item selectors are typed as ProviderListenable, so call sites building
// them need the type without reaching into riverpod's misc library themselves.
...
// Each config item watches its own selector so a single setting change rebuilds
// one row rather than the whole section.
