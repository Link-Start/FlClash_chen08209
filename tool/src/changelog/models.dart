...
const changelogLocales = <String>[changelogFallbackLocale, 'zh-CN', 'ja', 'ru'];
...
class ChangelogEntry {
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
    ...
    'text': <String, dynamic>{
      for (final locale in changelogLocales)
        if (text[locale] != null) locale: text[locale],
    },
  };
  ...
  static ChangelogEntry fromJson(Map<String, dynamic> json) => ChangelogEntry(
    ...
    text: <String, String>{
      for (final entry in (json['text'] as Map<String, dynamic>).entries)
